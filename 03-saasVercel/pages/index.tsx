      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center py-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
            AI-powered assistant that generates professional summaries, action items, and sales communications from your product
          </p>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Generate comprehensive research summaries from your notes
                </p>
              </div>
            </div>
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Clear next steps and follow-up actions for every suggestions
                </p>
              </div>
            </div>
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Draft clear, sales friendly email communications automatically
                </p>
              </div>
            </div>
          </div>
